        ...
        <div className="w-full md:w-1/2">
          ...
          <div>
            <div className='social-links flex opacity-100'>
                <div className='social-btn overflow-hidden relative flex items-center justify-center cursor-pointer px-3 h-12 w-12 rounded-md shadow-md bg-white m-2 ml-0' id="twitter">
                ...
                <div className='social-btn overflow-hidden relative flex items-center justify-center cursor-pointer px-3 h-12 w-12 rounded-md shadow-md bg-white m-2' id="linkedin">
                ...
                <div className='social-btn overflow-hidden relative flex items-center justify-center cursor-pointer px-3 h-12 w-12 rounded-md shadow-md bg-white m-2' id="github">
