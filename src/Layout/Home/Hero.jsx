    ...
    <div className="flex items-center min-h-screen pt-[120px] pb-[90px] lg:py-[180px]">
      <div className="container h_container px-4 md:px0 flex items-center flex-col md:flex-row">
        <div className="w-full md:w-1/2">
          ...
          <div>
            <div className='social-links link flex opacity-100'>
                <div className='social-btn overflow-hidden relative flex items-center justify-center px-3 h-12 w-12 rounded-md shadow-md bg-white m-2 ml-0' id="twitter">
